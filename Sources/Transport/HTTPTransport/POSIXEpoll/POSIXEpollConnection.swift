...
//
    ...
    public final class POSIXEpollConnection: TransportConnection {
        ...
        ///
        /// The ownership check is the machine-checked half of the contract on this side (audit F-03):
        ...
        /// `PortableTLSConnection.drainCiphertext`'s ownership check. One uncontended
