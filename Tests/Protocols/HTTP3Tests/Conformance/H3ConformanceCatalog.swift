...
enum H3Conformance {
    ...
    private static func stamped(_ check: H3Check) -> H3Check {
        ...
        switch check.layer {
            case .http3, .qpack:
                stamped.status = .supported
            case .quicTransport, .quicTLS:
                stamped.status = .platform
        }
        return stamped
    }
    ...
    private static let quicTLS: [H3Check] = [
        H3Check(
            ...
            .quicTLS,
            "§6",
            "KeyUpdate in a Handshake packet",
            "TLS unexpected_message"
        ),
        H3Check(
            .h3spec,
            .quicTLS,
            "§6",
            "KeyUpdate in a 1-RTT packet",
            "TLS unexpected_message"
        ),
        H3Check(
            .h3spec,
            .quicTLS,
            "§8.1",
            "no supported application protocol (ALPN)",
        ...
        H3Check(
            ...
            .quicTLS,
            "§8.2",
            "quic_transport_parameters extension absent",
            "TLS missing_extension"
        ),
        H3Check(
            .h3spec,
            .quicTLS,
            "§8.2",
            "quic_transport_parameters extension under the wrong id",
            "TLS missing_extension"
        ),
        H3Check(
            .h3spec,
        ...
        H3Check(
            ...
            .quicTLS,
            "§8.3",
            "CRYPTO in a 0-RTT packet (requires a 0-RTT ticket)",
            "PROTOCOL_VIOLATION"
        )
    ]
    ...
    private static let http3: [H3Check] = [
        ...
        H3Check(
            ...
            .http3,
            "§4.1.1",
            "a duplicated pseudo-header field",
        ...
        H3Check(
            ...
            .http3,
            "§4.1.3",
            "a mandatory pseudo-header field is absent",
            "H3_MESSAGE_ERROR (0x010e)"
        ),
        H3Check(
            .h3spec,
            .http3,
            "§4.1.3",
            "a prohibited pseudo-header field is present",
            "H3_MESSAGE_ERROR (0x010e)"
        ),
        H3Check(
            .h3spec,
            .http3,
            "§4.1.3",
            "a pseudo-header field after regular fields",
            "H3_MESSAGE_ERROR (0x010e)"
        ),
        H3Check(
            .h3spec,
            .http3,
            "§6.2.1",
            "the first control-stream frame is not SETTINGS",
        ...
        H3Check(
            ...
            .http3,
            "§7.2.2",
            "a HEADERS frame on the control stream",
            "H3_FRAME_UNEXPECTED (0x0105)"
        ),
        H3Check(
            .h3spec,
        ...
        H3Check(
            ...
            .http3,
            "§7.2.4.1",
            "an HTTP/2-only setting identifier is present",
        ...
        H3Check(
            ...
            .http3,
            "§7.2.5",
            "CANCEL_PUSH received on a request stream",
            "H3_FRAME_UNEXPECTED (0x0105)"
        )
    ]
    ...
    private static let qpack: [H3Check] = [
        ...
        H3Check(
            ...
            .qpack,
            "§4.1.3/§4.3.1",
            "a Set Dynamic Table Capacity above the limit",
        ...
        H3Check(
            ...
            .qpack,
            "§4.2",
            "a critical (encoder) stream is closed",
    ...
    private static let gaps: [H3Check] = [
        H3Check(
            ...
            .http3,
            "§6.2.1",
            "a second control stream is created",
        ...
        H3Check(
            ...
            .http3,
            "§6.2.1",
            "the peer's control stream is closed",
            "H3_CLOSED_CRITICAL_STREAM (0x0104)"
        ),
        H3Check(
            .rfc9114,
            .http3,
            "§7.2.5",
            "a PUSH_PROMISE frame on the control stream",
            "H3_FRAME_UNEXPECTED (0x0105)"
        ),
        H3Check(
            .rfc9114,
            .http3,
            "§5.2/§7.2.6",
            "a GOAWAY identifier that increases",
            "H3_ID_ERROR (0x0108)"
        ),
        H3Check(
            .rfc9114,
            .http3,
            "§7.2.7",
            "a Push ID greater than MAX_PUSH_ID",
            "H3_ID_ERROR (0x0108)"
        ),
        H3Check(
            .rfc9114,
            .http3,
            "§7.1",
            "a frame whose length runs past the stream",
        ...
        H3Check(
            ...
            .http3,
            "§4.2",
            "a TE header field with a value other than trailers",
            "H3_MESSAGE_ERROR (0x010e)"
        ),
        H3Check(
            .rfc9114,
            .http3,
            "§4.1.2",
            "a content-length not matching the DATA length",
            "H3_MESSAGE_ERROR (0x010e)"
        ),
        H3Check(
            .rfc9204,
            .qpack,
            "§4.2",
            "a second QPACK encoder or decoder stream",
            "H3_STREAM_CREATION_ERROR (0x0103)"
        ),
        H3Check(
            .rfc9204,
            .qpack,
            "§3.1",
            "a reference to an evicted dynamic-table entry",
            "QPACK_DECOMPRESSION_FAILED (0x0200)"
        ),
        H3Check(
            .rfc9204,
        ...
        H3Check(
            ...
            .http3,
            "§4.1",
            "a DATA frame before any HEADERS on a request stream",
            "H3_FRAME_UNEXPECTED (0x0105)"
        ),
        H3Check(
            .rfc9114,
            .http3,
            "§7.2.6",
            "a GOAWAY frame on a request stream",
            "H3_FRAME_UNEXPECTED (0x0105)"
        ),
        H3Check(
            .rfc9114,
            .http3,
            "§7.2.4",
            "a SETTINGS frame on a request stream",
            "H3_FRAME_UNEXPECTED (0x0105)"
        ),
        H3Check(
            .rfc9114,
        ...
        H3Check(
            ...
            .http3,
            "§7.2.3",
            "a CANCEL_PUSH for a Push ID above MAX_PUSH_ID",
            "H3_ID_ERROR (0x0108)"
        ),
        ...
        H3Check(
            ...
            .http3,
            "§7.2.4",
            "a duplicate setting identifier in one SETTINGS frame",
            "H3_SETTINGS_ERROR (0x0109)"
        ),
        H3Check(
            .rfc9114,
