...
#define BORINGSSL_PREFIX CHTTPBoringSSL
...
// opensslconf.h.
#include "CHTTPBoringSSL_is_boringssl.h"
#include "CHTTPBoringSSL_opensslconf.h"
#include "CHTTPBoringSSL_target.h"  // IWYU pragma: export
